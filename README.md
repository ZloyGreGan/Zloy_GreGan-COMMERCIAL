...
Привет. Я Java-разработчик с опытом коммерческой разработки модов/плагинов и игровых систем для Minecraft 1.6.4 - 1.12.2.

За 5 лет я разработал десятки модификаций и плагинов: от отдельных механик и GUI до полноценных игровых систем и переработки существующего кода. Делаю упор на чистую архитектуру, производительность, расширяемость и поддержку проекта в долгосрочной перспективе.

🔹 Что я предлагаю?  

✔ Разработка модов/плагинов с нуля  
✔ Доработка, рефакторинг и переписывание существующих модификаций/плагинов  
✔ Реализация сложных игровых механик и кастомной логики  
✔ Разработка пользовательского интерфейса (GUI/HUD) любой сложности  
✔ Проектирование и поддержка API для интеграции между системами  
✔ Переработка игровых систем и core-логики проекта  
✔ Разработка Telegram / Discord ботов под задачи проекта  
✔ Продажа готовых технических решений и собственных наработок  
✔ Портирование модов/плагинов между версиями (1.6.4 - 1.12.2)  
✔ Написание аддонов для для популярных модификаций (AE2, IC2 и тд)

🔹 Гарантия конфиденциальности  

Все данные и детали проекта остаются строго конфиденциальными. При необходимости готов подписать NDA или работать по договору. 

🔹 Оплата  

Работа осуществляется по предоплате 25% или по согласованной схеме сотрудничества, в зависимости от объёма и формата проекта.

✔ Сбербанк / ТБанк / Ozon Банк  
✔ Крипта  
...
__Берусь как за точечные задачи, так и за полноценную разработку проекта.__   
